...
from compound_embedding.fs_mol.utils.logging import PROGRESS_LOG_LEVEL
...
def resolve_starting_model_file(
    ...
    if use_fresh_param_init:
        ...
        resolved_model_file = os.path.join(out_dir, "fresh_init.pkl")
...
def train_loop(
    ...
    for epoch in range(0, max_num_epochs):
        ...
        logger.log(log_level, "  = Validation")
